...
namespace LabCenter.Shared.Models
{
    ...
    public record WorkPlanCreationModel(WorkType Type, DateTimeOffset StartTime, DateTimeOffset EndTime, int MaxUsers, int Minutes, Room ClassRoom, bool SalaryBonus, string? Note, List<string> UserIds, int RepeatWeeks = 1);
